                  ...
                  >
                    <div className="flex px-3 justify-end">
                      ...
                      {userFollowingGroups?.find(
                        (followingGroup) =>
                          followingGroup === trip?.group_id?._id
                      ) === trip?.group_id?._id ? (
                        <div
                    ...
                    <Link to="/trips" state={trip?._id}>
                      ...
                      trip?.trip_location?.images?.photos.length ===
                        undefined ? (
                        <img
                          src="/no-image.gif"
                          alt="img"
                        ...
                        <img
                          src={
                            trip?.trip_location?.images?.photos[0].src.original
                          }
            ...
            <section>
              <div className="parallax-three bg-[url('https://images.unsplash.com/photo-1440688807730-73e4e2169fb8?dpr=1&auto=format&fit=crop&w=1500&h=1001&q=80&cs=tinysrgb&crop=')]">
                ...
                {groups.map((group) => (
                  <div
                    key={group?._id}
                    className="relative mb-8 z-10 transition-all min-w-max h-28 bg-lightColor/60 backdrop-blur-sm mx-4 rounded shadow-lightColor/40 shadow-md hover:shadow-lg hover:shadow-lightColor/60 hover:bg-secondaryColor/90 cursor-pointer"
                  >
                    <div className="flex px-3 justify-end">
                      <Link to="/group" state={{ link_group_id: group?._id }}>
                        <img
                          className="w-20 h-20 my-4 rounded-full absolute left-4"
                          src={
                            group?.group_profile || "/group_default_profile.jpg"
                          }
                          alt="dp"
                        />

                        <div className="mt-9 mr-4 ml-16 text-gray-800 flex-col flex absolute left-14">
                    ...
                    <div className="hidden sm:flex justify-center ">
                        {/*TODO: <span>3 months trip</span> */}
                        <span><span className="text-xl">"</span>{group?.description}<span className="text-xl">"</span></span>
                    </div>
                  </div>
                ))}
              </div>
